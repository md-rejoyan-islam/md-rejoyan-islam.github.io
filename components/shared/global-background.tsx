  ...
  return (
    <>
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        {/* Base background */}
        <div className="absolute inset-0 bg-white dark:bg-[#08080f]" />
        ...
        <div
          ...
          style={{
            background: isDark
              ...
              : `radial-gradient(circle 600px at ${mousePos.x}px ${mousePos.y}px, rgba(99, 102, 241, 0.05), transparent 80%)`,
          }}
        />

        {/* Left side gradient */}
        <div className="fixed left-0 top-1/2 -translate-y-1/2 -translate-x-1/2 w-[500px] h-[500px] rounded-full pointer-events-none z-0">
        ...
        {/* Right side gradient */}
        <div className="fixed right-0 top-1/2 -translate-y-1/2 translate-x-1/2 w-[500px] h-[500px] rounded-full pointer-events-none z-0">
          <div className="w-full h-full rounded-full bg-gradient-to-bl from-cyan-500/15 via-blue-500/12 to-indigo-500/10 dark:from-cyan-500/25 dark:via-blue-500/20 dark:to-indigo-500/15 blur-[100px]" />
        </div>

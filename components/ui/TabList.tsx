    ...
    >
      {tabs.map((link, i) => (
        <motion.button
          ...
          className={twMerge(
            "transition-colors border duration-200  text-[16px] text-text-secondary bg-transparent  hover:bg-[#e9f7fe] hover:text-[var(--primary-button)] flex items-center dark:border-[#222c64] dark:hover:bg-[#161c40] border-[#c8edff] justify-center rounded-md h-fit px-2 py-1 text-nowrap",
            currentLink.index === i &&
